                ...
                <div class="flex flex-col gap-2 md:gap-4 mb-4">
                    ...
                    <div class="flex flex-col gap-1 md:gap-2">
                        <div class="flex items-center justify-between gap-2 md:gap-4">
                            <!-- Desktop: Date | Time, Mobile: Date only -->
                            <div class="flex items-center gap-1 md:gap-2">
                                <span class="text-gray-600 dark:text-gray-400 font-medium text-xs md:text-lg">{{ currentDate }}</span>
                                <span class="hidden md:inline text-gray-400 font-normal md:text-lg">|</span>
                                <span class="hidden md:inline text-gray-600 dark:text-gray-400 font-medium md:text-lg">{{ currentTime }}</span>
                            </div>
                        ...
                        <!-- Mobile Time Only -->
                        <div class="md:hidden">
                            <span class="text-gray-900 dark:text-gray-100 font-black text-2xl tracking-tight">{{ currentTime }}</span>
                        </div>
                    </div>
                </div>
