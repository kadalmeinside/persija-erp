...
class MasterDataBudgetSeeder extends Seeder
{
    ...
    {
        // PERBAIKAN: Gunakan absolute path langsung ke storage/app/seeders
        ...
        // Debugging: Cetak path yang dicari agar Anda bisa verifikasi
        ...
        DB::transaction(function () use ($absolutePath, $tahunAnggaran) {
            ...
            $skipRows = 5; 
            $lastKodeAkunPrefix = '5-0101'; 

            // Gunakan fopen standar PHP
            if (($handle = fopen($absolutePath, "r")) !== false) {
                ...
                while (($row = fgetcsv($handle, 1000, ';')) !== false) {
                    ...
                    // 3. Cek Baris Data Utama (Punya Kode Akun)
