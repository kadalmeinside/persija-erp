...
class PermissionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/Permissions/Index', [
            ...
            'can' => [
                'create_permission' => $request->user()->can('permissions.manage'),
                'edit_permission' => $request->user()->can('permissions.manage'),
                'delete_permission' => $request->user()->can('permissions.manage'),
            ]
        ]);
    }
